...
<head>
    ...
    <title>indya.com - Lehengas</title>
</head>
<body>
<div class="nav">
        <div class="top">
    ...
    <div class="header">
        <h2>Our Lehenga Set</h2>
        <span>Products >> Lehenga Set</span>
    </div>
   
    <div class="tray">
    <?php
            $result = mysqli_query($conn, "SELECT * FROM `products` WHERE type = 'Lehenga Sets'; ");
