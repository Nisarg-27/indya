...
<body>
    <div class="left">
        ...
        <a class="block active" href="seller.php">
            <span>Account</span>
        </a>
    ...
    <div class="right">
        <h1>Dashboard</h1>
        <div class="form">
            <p><span>Company Name: </span>Indya Pvt. Ltd.</p>
            <p><span>Company Location: </span>Pune</p>
            <p><span>GST Number: </span>23479817</p>
        </div>
        <div class="orders">
            <?php
            ...
            <a class="order" href="order.php">
                ...
                <span>Grand Total: <?php echo $row['grand_total'] ?></span>
                <span>Payment Type: <?php echo $row['Payment_status'] ?></span>
                <span>Payment Status: <?php echo $row['Payment_type'] ?></span>
                <span>Order Shippment: Shipped</span>
            </a>
            <?php } ?>
        </div>
    </div>
