...
<div class="nav">
    ...
    <div class="header">
        <h2>Our Nehru Jacket & Blazers</h2>
        <span>Products >> Nehru Jacket & Blazers</span>
    </div>
   
    <div class="tray">
    <?php
            $result = mysqli_query($conn, "SELECT * FROM `products` WHERE type = 'Nehru Jackets & Blazers'; ");
